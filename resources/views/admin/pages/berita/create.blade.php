            ...
            <div class="col-md-12">
                <div class="card strpied-tabled-with-hover">
                    <div class="card-header ">
                        <div class="row">
                            ...
                            <div class="col d-flex justify-content-end">
                                <h4 class="card-title font-weight-normal">Buat berita Baru</h4>
                            </div>
                        </div>
                    </div>
                    @if ($errors->any())
                    ...
                    <div class="card-body mx-5">
                        ...
                        <form method="POST" action="{{ route('admin.berita.store') }}" enctype="multipart/form-data" id="form">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="description form-control @error('isi') is-invalid @enderror" name="isi" id="isi" rows="15" required>{{ old('isi') ? old('isi') : '' }}</textarea>
                                @error('isi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
