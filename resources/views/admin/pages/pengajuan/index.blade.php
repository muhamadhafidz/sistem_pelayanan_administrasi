              ...
              <div class="card-header ">
                  <div class="row ">
                      <div class="col ">
                        ...
                        <h2 class="card-title font-weight-bold ">Daftar Pengajuan Dokumen</span></h2>
                      </div>
                  </div>
              </div>
              <div class="card-body">
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              @elseif ($item->status == "diproses" || $item->status == "ditinjau")
                            ...
                            @if (Auth::user()->hak_akses == "admin")
                             ...
                             <form class="d-inline" action="{{ route('admin.pengajuan.batal', $item->id) }}" method="POST">
                               @csrf
                               @method('PUT')
                               <button class="btn btn-outline-danger btn-sm p-1" type="submit">Batalkan Pengajuan</button>
                             </form>
                             <form class="d-inline" action="{{ route('admin.pengajuan.setujui', $item->id) }}" method="POST">
                               @csrf
                               @method('PUT')
                               <button class="btn btn-success btn-sm p-1" type="submit">Setujui</button>
                             </form>
                              @else
                            ...
                            @endif
                             ...
                             @if (Auth::user()->hak_akses == "kades")
                                @if ($item->status == 'diproses')
                                    <form class="d-inline" action="{{ route('admin.pengajuan.tandatangan', $item->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <button class="btn btn-primary btn-sm p-1" type="submit">Tanda Tangani</button>
                                    </form>
                                @endif
                             @endif
                            </td>
